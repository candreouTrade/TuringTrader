...
namespace TuringTrader.Algorithms.Glue
{
    ...
    public static class Globals
    {
        ...
        public static DateTime END_TIME = DateTime.Now.Date.AddDays(-1);
        //public static DateTime END_TIME = DateTime.Now.Date + TimeSpan.FromHours(16);
        //        public static readonly DateTime END_TIME = START_TIME + TimeSpan.FromDays(700);
    ...
    public static class Assets
    {
        ...
        public static readonly string STOCKS_US_LG_CAP = "SPY";
